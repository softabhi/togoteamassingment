...
function Regi() {
    ...
    const validation = () => {
        ...
        if (!user.fname.trim()) {
            errors.fname = "Password is required";
            isValid = false;
        }
        if (!user.lname) {
                ...
                <MDBCol md='6'>
                    ...
                    <MDBCard className='my-5'>
                        <MDBCardBody className='p-5'>
                            ...
                            <MDBRow>
                                <MDBCol col='6'>
                                    <MDBInput wrapperClass='mb-4' label='First name' id='form1' type='text' name='fname' value={user.fname} onChange={handleChange} />
                                </MDBCol>

                                <MDBCol col='6'>
                                    <MDBInput wrapperClass='mb-4' label='Last name' id='form1' type='text' name='lname' value={user.lname} onChange={handleChange} />
                                </MDBCol>
                            </MDBRow>
                            ...
                            <MDBBtn className='w-100 mb-4' size='md' onClick={submitFuction}>sign up</MDBBtn>
